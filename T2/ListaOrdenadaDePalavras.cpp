...
#include "ContList.hpp"
    ...
    ListaOrdenadaDePalavras::ListaOrdenadaDePalavras() : primeiro(nullptr), head(nullptr), tail(nullptr), middle(nullptr), count(0), flag(false){
    ...
    while (atual) {
        ...
        //atual->imprimeOcorrencia();  // Chama a função para imprimir a lista de ocorrência
